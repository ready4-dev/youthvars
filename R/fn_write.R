    ...
    x_labels_chr = character(0)) 
{
    ...
    plots_params_ls <- list(qstn_rspns = list(plt_fn = make_itm_resp_plts, 
        ...
        options_chr = options_chr, path_to_write_to_1L_chr = descv_outp_dir_1L_chr, 
        plt_nm_1L_chr = "qstn_rspns", width_1L_dbl = item_plots_params_ls$width_1L_dbl), 
        wtd_sub_tots = list(plt_fn = make_sub_tot_plts, fn_args_ls = list(data_tb, 
            ...
            options_chr = options_chr, path_to_write_to_1L_chr = descv_outp_dir_1L_chr, 
            plt_nm_1L_chr = "wtd_sub_tots", width_1L_dbl = dim_plots_params_ls$width_1L_dbl), 
        ll_sub_tot = list(plt_fn = make_sub_tot_plts, fn_args_ls = list(data_tb, 
            col_nms_chr = maui_domains_col_nms_chr, plot_rows_cols_pair_int = dim_plots_params_ls$plot_rows_cols_pair_int, 
            round_var_nm_1L_chr = ds_descvs_ls$round_var_nm_1L_chr, 
            heights_int = dim_plots_params_ls$heights_int, make_log_log_tfmn_1L_lgl = T, 
            x_labels_chr = x_labels_chr), consent_1L_chr = consent_1L_chr, 
            consent_indcs_int = consent_indcs_int, height_1L_dbl = sum(dim_plots_params_ls$heights_int), 
            options_chr = options_chr, path_to_write_to_1L_chr = descv_outp_dir_1L_chr, 
            plt_nm_1L_chr = "ll_sub_tot", width_1L_dbl = dim_plots_params_ls$width_1L_dbl), 
        utl_by_rnd = list(plt_fn = make_var_by_round_plt, fn_args_ls = list(data_tb, 
            var_nm_1L_chr = ds_descvs_ls$utl_wtd_var_nm_1L_chr, 
            round_var_nm_1L_chr = ds_descvs_ls$round_var_nm_1L_chr, 
            x_label_1L_chr = ds_descvs_ls$dictionary_tb %>% ready4::get_from_lup_obj(match_value_xx = ds_descvs_ls$utl_wtd_var_nm_1L_chr, 
                match_var_nm_1L_chr = "var_nm_chr", target_var_nm_1L_chr = "var_desc_chr", 
                evaluate_1L_lgl = F) %>% as.vector()), consent_1L_chr = consent_1L_chr, 
            consent_indcs_int = consent_indcs_int, height_1L_dbl = utl_by_rnd_plots_params_ls$height_1L_dbl, 
            options_chr = options_chr, path_to_write_to_1L_chr = descv_outp_dir_1L_chr, 
            plt_nm_1L_chr = "utl_by_rnd", width_1L_dbl = utl_by_rnd_plots_params_ls$width_1L_dbl))
