...
#' Make new youthvars S3 class for Screen for Child Anxiety Related Disorders (SCARED) scores
...
#' Make prototype youthvars S3 class for Screen for Child Anxiety Related Disorders (SCARED) scores
...
#' Validate youthvars S3 class for Screen for Child Anxiety Related Disorders (SCARED) scores
...
x}
#' Is youthvars S3 class for Screen for Child Anxiety Related Disorders (SCARED) scores
