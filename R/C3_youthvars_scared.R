...
if(any(x < 0)){
stop("All values in valid youthvars_scared object must be greater than or equal to 0.",
call. = FALSE)
}
 if(any(x > 82)){
stop("All values in valid youthvars_scared object must be less than or equal to 82.",
call. = FALSE)
}
x}
