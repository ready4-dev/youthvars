...
if(any(x < 0)){
stop("All values in valid youthvars_bads object must be greater than or equal to 0.",
call. = FALSE)
}
 if(any(x > 150)){
stop("All values in valid youthvars_bads object must be less than or equal to 150.",
call. = FALSE)
}
x}
