...
#' Make new youthvars S3 class for Generalised Anxiety Disorder Scale (GAD-7) scores
...
#' Make prototype youthvars S3 class for Generalised Anxiety Disorder Scale (GAD-7) scores
...
#' Validate youthvars S3 class for Generalised Anxiety Disorder Scale (GAD-7) scores
...
x}
#' Is youthvars S3 class for Generalised Anxiety Disorder Scale (GAD-7) scores
