...
#' @param tmp_row_nbr_var_nm_1L_chr Temporary row number variable name (a character vector of length one), Default: 'tmp_row_nbr_int'
...
add_interval_var <- function (data_tb, id_var_nm_1L_chr = "fkClientID", msrmnt_date_var_nm_1L_chr = "d_interview_date", 
    ...
    interval_var_nm_1L_chr = "interval_dbl", tmp_row_nbr_var_nm_1L_chr = "tmp_row_nbr_int", 
    drop_bl_date_var_1L_lgl = F) 
{
    updated_data_tb <- data_tb %>% dplyr::ungroup() %>% dplyr::mutate(`:=`(!!rlang::sym(tmp_row_nbr_var_nm_1L_chr), 
        ...
        dplyr::ungroup() %>% dplyr::arrange(!!rlang::sym(tmp_row_nbr_var_nm_1L_chr)) %>% 
