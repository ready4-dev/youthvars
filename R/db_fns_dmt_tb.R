#' youthvars function documentation table
#' 
#' Meta-data on each youthvars function used to create package documentation
#' 
#' A tibble
#' 
#' \describe{
...
#' }
#' @source \url{https://ready4-dev.github.io/youthvars/}
"fns_dmt_tb"
