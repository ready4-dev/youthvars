...
#' Make new youthvars S3 class for Kessler Psychological Distress Scale (K6) - US Scoring System scores
...
#' Make prototype youthvars S3 class for Kessler Psychological Distress Scale (K6) - US Scoring System scores
...
#' Validate youthvars S3 class for Kessler Psychological Distress Scale (K6) - US Scoring System scores
...
x}
#' Is youthvars S3 class for Kessler Psychological Distress Scale (K6) - US Scoring System scores
