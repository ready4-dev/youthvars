---
title: "Creating Descriptive Tables and Plots"
output: 
  ...
  pdf_document:
    ...
    number_sections: yes
vignette: >
  %\VignetteIndexEntry{Creating Descriptive Tables and Plots}
...
## Ingest data
The tools in `youthvars` extend classes and methods from the [ready4use](https://ready4-dev.github.io/ready4use/) package. Our starting point is `x`, a `Ready4useDyad` (dataset and data dictionary pair) that we can download from a remote repository.
...
```{r}
x <- renewSlot(x,
               profiled_vars_ls = list(temporal = c("d_age","d_sexual_ori_s","d_studying_working"),  
                                       temporal_tested = c("k6_total", "phq9_total", "bads_total"), 
                                       participation_tested = c("k6_total", "phq9_total", "bads_total")),
