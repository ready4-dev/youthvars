...
output:
  ...
  rmarkdown::html_vignette:
    toc: yes
vignette: |
  %\VignetteIndexEntry{Tools to create summary tables and plots} %\VignetteEncoding{UTF-8} %\VignetteEngine{knitr::rmarkdown}
---
...
Some of the functions we are illustrating in this vignette also require that the dataset has a dictonary of the `ready4_dictionary` class.
