...
write_descv_tbls <- function(data_tb,
  ...
  descv_tbl_ls <- list(cohort_desc_tb = make_descv_stats_tbl(data_tb = data_tb, #
                       ...
                       main_outc_tbl_tb = make_descv_stats_tbl(data_tb = data_tb, #
                                                               ...
                                                               test_1L_lgl = T,
                                                               nbr_of_digits_1L_int = nbr_of_digits_1L_int),
                       outc_by_partcn_tbl_tb = make_descv_stats_tbl(data_tb = data_tb[data_tb$round == "Baseline",], #
                                                                    ...
                                                                    test_1L_lgl = T,
                                                                    nbr_of_digits_1L_int = nbr_of_digits_1L_int),
                       bl_cors_tb = transform_ds_for_tstng(data_tb,dep_var_max_val_1L_dbl = Inf, candidate_predrs_chr = ds_descvs_ls$candidate_predrs_chr) %>%
                         make_corstars_tbl_xx(result_chr = "none"),##
                       fup_cors_tb = transform_ds_for_tstng(data_tb,dep_var_max_val_1L_dbl = Inf, candidate_predrs_chr = ds_descvs_ls$candidate_predrs_chr, round_val_1L_chr = "Follow-up") %>%
                         make_corstars_tbl_xx(result_chr = "none"),
