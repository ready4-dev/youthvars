...
get_journal_palette_fn <- function(type_1L_chr = c("colour", "fill"),
                                   what_1L_chr = "lancet"){
  lifecycle::deprecate_soft("0.0.0.9127","youthvars::get_journal_palette_fn()","ready4use::get_journal_palette_fn()")
  # type_1L_chr <- match.arg(type_1L_chr)
  journal_palette_fn <- ready4use::get_journal_palette_fn(type_1L_chr = type_1L_chr, what_1L_chr = what_1L_chr)
