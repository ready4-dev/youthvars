...
ready4fun::make_pkg_desc_ls(pkg_title_1L_chr = "Youth Mental Health Variables Description Toolkit",
                            pkg_desc_1L_chr = "Tools to describe, summarise and score types of data commonly present in youth mental health collections.
